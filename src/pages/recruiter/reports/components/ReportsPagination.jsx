...
/**
 * Figma pagination strip: 1097x64. `Previous` 111x36 pinned left, numbered
 * 40x40 buttons centred with 2px gaps, `Next` 84x36 pinned right.
 */
...
export function ReportsPagination({ page, totalPages, onPageChange }) {
